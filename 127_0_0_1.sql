...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 26. Mrz 2022 um 15:22
...
('root', '[{\"db\":\"schooldex\",\"table\":\"nachhilfe\"},{\"db\":\"schooldex\",\"table\":\"ag\"},{\"db\":\"schooldex\",\"table\":\"Ag\"},{\"db\":\"Schooldex\",\"table\":\"nachhilfe\"}]');
...
('root', '2022-03-26 12:50:09', '{\"lang\":\"de\",\"collation_connection\":\"utf8mb4_unicode_ci\"}');
...
-- Datenbank: `schooldex`
--
CREATE DATABASE IF NOT EXISTS `schooldex` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `schooldex`;
...
INSERT INTO `nachhilfe` (`fach`, `jahrgang`, `farbe`, `beschreibung`, `id`) VALUES
('mathe', 7, 'blue', 'test', 1);
